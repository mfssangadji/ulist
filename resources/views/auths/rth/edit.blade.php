            ...
            <form role="form" method="post" name="frm" action="{{ route('rth').'/'.$rth->id }}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group @error('nama_lokasi') has-error @enderror">
                  ...
                  <input type="text" name="nama_lokasi" value="{{$rth->nama_lokasi}}" id="nama_lokasi" class="form-control">
                  @error('nama_lokasi')
                ...
                <div class="form-group @error('keterangan') has-error @enderror">
                  ...
                  <textarea name="keterangan" class="form-control" id="keterangan">{{ html_entity_decode($rth->keterangan) }}</textarea>
                  @error('keterangan')
              ...
              <div class="box-footer">
                ...
                <a href="{{ route('rth') }}" type="button" class="btn btn-default">Batal</a>
              </div>
            </form>
      	  </div>
      	</div>
