<?php $__env->startSection('title', 'Detail Ruang Terbuka Hijau (RTH)'); ?>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Detail Ruang Terbuka Hijau (RTH)</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <select class="form-control" disabled id="kelurahan_id" name="kelurahan_id" data-placeholder=""
                          style="width: 100%;">
                    <?php $__currentLoopData = $kelurahan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelurahan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($kelurahan->id == $rth->kelurahan_id): ?>)
...
unset($__errorArgs, $__bag); ?>">
                  <label>Jenis</label>
                  <select class="form-control" disabled id="jenis" name="jenis" style="width: 100%;">
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <input type="text" name="nama_lokasi" disabled value="<?php echo e($rth->nama_lokasi); ?>" id="nama_lokasi" class="form-control">
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <input type="text" name="luas" disabled value="<?php echo e($rth->luas); ?>" id="luas" class="form-control">
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <img src="<?php echo e(asset('uploads/'.$rth->gambar)); ?>" style="width: 500px; border-radius: 10px;">
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <div class="code"><?php echo $rth->keterangan; ?></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auths.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scripty\indra\resources\views/auths/rth/view.blade.php ENDPATH**/ ?>