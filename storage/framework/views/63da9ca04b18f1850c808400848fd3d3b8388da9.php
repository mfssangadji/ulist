<?php $__env->startSection('title', 'Tambah SPOT'); ?>
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <select class="form-control select2" multiple="multiple" id="jenis_spot_id" name="jenis_spot_id" data-placeholder=""
                    ...
                    <?php $__currentLoopData = $kelurahan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelurahan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($kelurahan->id == old('jenis_spot_id')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auths.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scripty\ulis\resources\views/auths/rth/create.blade.php ENDPATH**/ ?>