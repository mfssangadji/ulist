	...
	<div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo e(route('kelurahan').'/'.$kelurahan->id); ?>">
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <select name="kecamatan_id" id="kecamatan_id" class="form-control">
                      ...
                      <?php $__currentLoopData = $kecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($kec->id == $kelurahan->kecamatan_id): ?>
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <input type="text" class="form-control" value="<?php echo e($kelurahan->nama_kelurahan); ?>" id="nama_kelurahan" name="nama_kelurahan" placeholder="masukan nama kelurahan">
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo e(route('kelurahan')); ?>" type="button" class="btn btn-default">Batal</a>
              </div>
            </form>
      	  </div>
      	</div>
...
<?php echo $__env->make('auths.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scripty\indra\resources\views/auths/kelurahan/edit.blade.php ENDPATH**/ ?>