        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Ubah RTH</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <input type="text" name="luas" value="<?php echo e($rth->luas); ?>" id="luas" class="form-control">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auths.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scripty\indra\resources\views/auths/rth/edit.blade.php ENDPATH**/ ?>