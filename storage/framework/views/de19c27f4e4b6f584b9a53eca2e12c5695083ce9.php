...
<body class="hold-transition skin-blue-light layout-boxed sidebar-mini" style="background:url('https://i.pinimg.com/originals/bd/46/6e/bd466ea87745086c841774f88d2b90f3.jpg') fixed; #DDD !important">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="logo">
      ...
      <span class="logo-lg"><b>GIS</b>System</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(route('users')); ?>"><i class="fa fa-circle-o"></i> Administrator</a></li>
            <li><a href="<?php echo e(route('kecamatan')); ?>"><i class="fa fa-circle-o"></i> Data Kecamatan</a></li>
            <li><a href="<?php echo e(route('kelurahan')); ?>"><i class="fa fa-circle-o"></i> Data Kelurahan</a></li>
          </ul>
        </li>
        <li>
          <a href="<?php echo e(route('rth')); ?>">
            <i class="fa fa-th text-green"></i> <span>Pendataan RTH</span>
          </a>
        </li>
        <li class="header">LABELS</li>
        <li><a href="<?php echo e(route('welcome')); ?>" target="_blank"><i class="fa fa-globe text-blue"></i> <span>Kunjungi Situs</span></a></li>
...
<?php /**PATH C:\xampp\htdocs\scripty\indra\resources\views/auths/layouts/app.blade.php ENDPATH**/ ?>