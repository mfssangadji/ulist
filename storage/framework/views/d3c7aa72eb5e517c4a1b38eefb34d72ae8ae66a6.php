...
<body class="hold-transition skin-blue-light layout-boxed sidebar-mini" style="background:url('http://rajaampatbiodiversity.com/wp-content/uploads/2017/12/raja-ampat-diving.jpg') fixed; #DDD !important">
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(route('jenis')); ?>"><i class="fa fa-circle-o"></i> Jenis SPOT</a></li>
          </ul>
        </li>
        <li>
          <a href="<?php echo e(route('rth')); ?>">
            <i class="fa fa-th text-green"></i> <span>Manajemen SPOT</span>
          </a>
        </li>
...
<?php /**PATH C:\xampp\htdocs\scripty\ulis\resources\views/auths/layouts/app.blade.php ENDPATH**/ ?>